...
class GlobalMediaLibrary(FingerprintMixin, GDriveMixin, DuplicateDetectionMixin, PathRelinkMixin, TagManagerMixin, AutoTaggerMixin):
    ...
    # Tag/learning methods → TagManagerMixin + AutoTaggerMixin    def get_assets(self, uids: List[str]) -> List[Dict]:
        if not uids:
            return []
