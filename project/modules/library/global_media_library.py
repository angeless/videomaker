...
try:
    ...
    gdown = None
# Constants are now in _constants.py (imported via wildcard above)
class GlobalMediaLibrary(CoreMixin, FingerprintMixin, GDriveMixin, DuplicateDetectionMixin, PathRelinkMixin, TagManagerMixin, AutoTaggerMixin):
