<template>
  <div>
    ...
    <div class="cap-section">
      ...
      <button class="btn btn-sm" @click="buildPlan" :disabled="!appStore.projectDir">生成策略</button>
    </div>
    ...
    <div class="cap-section">
      ...
      <div class="btn-row">
        <button class="btn btn-sm" @click="buildHandoff" :disabled="!appStore.projectDir">生成交接包</button>
        <button class="btn btn-primary btn-sm" @click="execute" :disabled="!appStore.projectDir">执行并启动</button>
      </div>
    </div>
    ...
    <div class="cap-section">
      ...
      <button class="btn btn-sm" @click="collect" :disabled="!appStore.projectDir">导回成片</button>
    </div>
